use crate::dsl::{ir::aqua::{ast_parser::ast_structure::AquaAST, into_renoir::{r_condition::process_where_clause, r_source::*}, r_sink::process_select_clause}, struct_object::object::QueryObject};
...
impl AquaToRenoir {
    pub fn convert(ast: &AquaAST, query_object: &QueryObject) -> String {
        ...
        let select_clause = &ast.select;
        final_string.push_str(&format!(
            "{}",
            process_select_clause(&select_clause, &query_object)
        ));
